...
Item {
    ...
    KickoffGridView {
        ...
        alwaysMaxColumns: plasmoid.configuration.favoritesAlwaysMaxColumns
        columns: plasmoid.configuration.favoritesColumns
        iconSize: plasmoid.configuration.favoritesIconSize
        enableSubtitles: plasmoid.configuration.favoritesEnableSubtitles
        labelPosition: plasmoid.configuration.favoritesLabelsPosition
