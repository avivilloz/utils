...
Item {
    ...
    height: (verticalMargin * 2) + Math.max(elementIcon.height, titleElement.implicitHeight + (plasmoid.configuration.hideAllSubtitles? 0:subTitleElement.implicitHeight))
    ...
    PlasmaCore.IconItem {
        ...
        width: plasmoid.configuration.iconSizeListViews
        height: width
    ...
    PlasmaComponents.Label {
        ...
        y: (!plasmoid.configuration.hideAllSubtitles)
    ...
    PlasmaComponents.Label {
        id: subTitleElement
        visible: (!plasmoid.configuration.hideAllSubtitles)
